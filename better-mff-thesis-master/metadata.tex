...
\def\Dedication{%
V první řadě bych chtěl poděkovat panu doc. Mgr. Michalu Žákovi, Ph.D. za trpělivost a věnovaný čas při vedení této práce. Za poskytnutá data a konzultace patří velké díky Mgr. Martinovi Kopeckému Ph.D. a doc. Ing. Janu Wildovi Ph.D. a jejich kolegyním a kolegům. Dále bych chtěl poděkovat Českému hydrometeorologickému ústavu za dostupná data z meteorologických stanic. Speciální poděkování patří mým nejbližším za pomoc a podporu při psaní práce.
}
